...
meta:
	ADDON_NAME = ofxFlex
	ADDON_DESCRIPTION = Wrapper for NVIDIA FleX
	ADDON_AUTHOR = Tobias Ensen
	ADDON_TAGS = "addon" "flex" "particles" "fluid" "simulation"
	ADDON_URL = http://github.com/tobiasebsen/ofxFlex
...
vs:
	...
	ADDON_DLLS_TO_COPY = libs/NvFlex/bin/vs/$(Platform)/$(Target)/*.dll
